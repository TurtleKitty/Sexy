...
func (s *SxyStream)    Answers     SxyObj
func (s *SxyStream)    Autos       SxyObj
func (s *SxyStream)    Default     SxyObj
func (s *SxyStream)    Messages    SxyObj
func (s *SxyStream)    Print       SxyObj
func (s *SxyStream)    Resends     SxyObj
func (s *SxyStream)    Send        SxyObj
func (s *SxyStream)    ToBool      SxyObj
func (s *SxyStream)    Type        SxyObj
func (s *SxyStream)    Write       SxyObj
                                ...
                                (if (keyword? head)
                                    (let ((kw (keyword->symbol head)))
                                        (case kw
                                            ...
                                            ((doc)      (sexy-read-rem port) (sexy-reader port))
